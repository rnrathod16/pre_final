...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mediumsignupmodal">
  Launch demo modal
</button> -->
<?php
        if((isset($_POST['m']))){
            ...
            // $message = "$lastname $firstname would like to request an account.";
              ...
              $query = "INSERT INTO `requests` (`firstname`, `lastname`, `username`, `password`, `pack`, `date`,`email`, `phone`, `address`) VALUES ('$firstname', '$lastname', '$username', '$password', 'medium', current_timestamp(), '$email', '$phone', '$address');";
...
<div class="modal fade" id="mediumsignupmodal" tabindex="-1" aria-labelledby="mediumsignupmodalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="mediumsignupmodalLabel">Medium Pack Signup</h5>
  ...
  <label for="exampleInputPack" class="form-label">Select one Pack</label>
    ...
    <input type="text"  class="form-control" value="Medium" id="exampleInputPack">
  </div>
...
<div class="form-group checkbox">
  ...
  <button type="submit" name="m" class="btn btn-primary col-3 my-3">SignUp</button>
  </div>
</form>
      </div>

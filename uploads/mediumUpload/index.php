...
<nav class="navbar center navbar-expand-lg navbar-dark bg-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="index.php">Medium Pack</a>
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
      <a class="nav-link" href="../../packages/medium.php">View Downloads</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
    <h5 class="card-title">Upload files to medium pack</h5>
    <div class="container ">
      <div class="row">
